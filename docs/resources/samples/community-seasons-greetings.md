...
---
# <a name="seasons-greetings"></a>シーズンの案内応答

このスクリプトは、ホリデー シーズンの精神 [でレス](https://www.linkedin.com/in/lesblackconsultant/) リー ブラックによって投稿されました。 このスクリプトは、Web 上の Excel で歌うクリスマス ツリーを、Web スクリプトを使用して表示Officeです。

お楽しみください!

[![シーズンの案内応答スクリプトの動作を確認する](../../images/community-seasons.png)](https://youtu.be/HBiGEkzmkgo "シーズンの案内応答スクリプトが動作中!")
